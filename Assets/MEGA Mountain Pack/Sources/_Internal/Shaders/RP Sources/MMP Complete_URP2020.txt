...
#define unity_WorldToObject GetWorldToObjectMatrix()
	...
	void Ext_SurfaceFunction0 (inout Surface o, ShaderData IN)
	{
        ...
        // Albedo
        half3 albedo = lerp(m[1], lerp(m[1], _FlowColor, splatmap.a), _FlowIntensity);

        // Normal
        float3 n = float3(m[0].xy * 2 - 1, 1);
        ...
        // Occlusion
        half occlusion = lerp(1, min(splatmap.b, m[0].z), _OcclusionIntensity);
